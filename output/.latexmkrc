...
#
# Downloaded from https://www.overleaf.com/learn/how-to/Cross_referencing_with_the_xr_package_in_Overleaf#Code_for_latexmkrc
# On 2024-07-17
#
...
$sub_doc_output = 'crossref_cache';

# Options to supply to latexmk for compilation of external documents:
@sub_doc_options = ();

# Note - Karl changed this -- original used -pdf
push @sub_doc_options, '-pdfxe'; # Use specified engine for compilation of external documents.
