...
generated quantities {
  ...
  // These are the common_A and alpha in the stan model, but adding more descriptive
  // names here for saving.
  vector[N] cost_param_A = rep_vector(common_A, N);
...

  {
    ...
    prob_leak = (leak_size_expect .* price * time_period_hr ./ common_A) ^ temp_inv_alpha;
